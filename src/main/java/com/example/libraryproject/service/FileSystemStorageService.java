...
public class FileSystemStorageService implements StorageService {
    ...
    public FileSystemStorageService() {
        this.location = Paths.get("src/main/resources/static/assets2/images");
    }
    ...
    public void delete(String fileName) {
        try {
            Path filePath = Paths.get("src/main/resources/static/assets2/images").resolve(fileName).normalize().toAbsolutePath();
